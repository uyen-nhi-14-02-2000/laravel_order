(function ($) {
    ...
    jQuery.extend(Order.prototype, {
        ...
        submitDataCallback: function (res) {
            if (res.data.status) {
                swal.fire({
                    ...
                    window.location = protocol + "//" + hostname + "/order/placed";
                });
            } else {
        ...
        validateError: function (err) {
            ...
            $("#order-page #customer-area .is-invalid").removeClass("is-invalid");
            $.each(err, function (key, value) {
                $("#order-page  #customer-area  #" + key).addClass("is-invalid");
        ...
        removeCart: function (
            ...
            izanagi(
                ...
                data,
                null,
                jQuery.Order.removeCartCallback
            );
        },
    ...
    try {
        ...
        $customerArea.on("click", "button", function (e) {
            ...
            if (parseInt(qtyProduct) <= 0) {
                swalAlert('error', 'Đặt hàng thất bại', 'Giỏ hàng trống! Vui lòng thêm món ăn vào giỏ hàng trước!');
                return;
            }
